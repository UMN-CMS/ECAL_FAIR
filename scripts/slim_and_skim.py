...
def pullSlimAndSkim(dst_file, oms_file, out_file=None, slim=True, max_xtals=10):
    ...
    data.t2 #table of the laser firing time per FED
    ...
    xtals = data.xtal_idx('(eta_module == 4) & (phi_module == 1) & (LME == 38)')
