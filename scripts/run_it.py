...
dst_dfs, xtals = dfb.pullSlimAndSkim('../ECAL_RADDAM_Data/2017/dst.w447.hdf5',
                                     '../ECAL_RADDAM_Data/2017/oms.hdf5', 
                                     out_file=None, 
                                     slim=False, 
                                     max_xtals=10000)
#load lumi_information
print('Loading lumi by month: ')
lumi_df = dfb.load_year('17','~/FAIR/Lumi_Data/2017/') 
...
for xtal, dst_df in zip(xtals, dst_dfs):
    ...
    iov_df = dfb.pullIOVtoDF('../ECAL_RADDAM_Data/2017/iov.w447.hdf5', ['p1','p2','p3'], xtal)
    print('Stitching...')
...
#save it out
final_df.to_csv('slimmed_df_LME38_PNA4_2017.csv', index=True)
